...
public final class SuperTreinoContract {
	 ...
	 */
	public static final class RefeicaoHasAlimentos implements BaseColumns {
		public static final String TABLE_NAME = "refeicao_alimento";
		/**
		 * The content URI for this table. 
		 */
		public static final Uri CONTENT_URI =  Uri.withAppendedPath(SuperTreinoContract.CONTENT_URI, "refeicao_has_alimentos");
		/**
		 * The mime type of a directory of refeicao_alimentos.
		 */
		public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/br.ufba.matc89.supertreino_refeicao_has_alimentos";
		/**
		 * The mime type of a single item.
		 */
		public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/br.ufba.matc89.supertreino_refeicao_has_alimentos";
		/*
		 * Colunas
		 */
		 ...
		 * A projection of all columns in the items table.
		 */
		public static final String[] PROJECTION_ALL = {_ID, ID_REFEICAO, ID_ALIMENTO, QUANTIDADE};
		/**
		 * The default sort order for queries containing NOME fields.
		 */
