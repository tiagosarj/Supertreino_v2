...
public class ExercicioCursorAdapter extends CursorAdapter{

    public ExercicioCursorAdapter(Context context, Cursor c){
        super(context, c, 0);
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        View retView = inflater.inflate(R.layout.layout_exercicio, parent, false);
